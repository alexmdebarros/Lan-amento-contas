...
tempo_por_lancamento_manual = 26.61
...
df = pd.read_csv("./lancamentos73.csv", sep=";", dtype={"Cta": str, "Vl_lancamento": str})  
...
for index, row in df.iterrows():
    ...
    pyautogui.write("BX CREDEV")
    time.sleep(0.5)
    pyautogui.press("tab")

    # 7️⃣ Preencher Histórico Auxiliar ("LUCRO" e tab)
    pyautogui.write("BX ADTO E CREDEV / DIVERSOS RECEB")
    time.sleep(0.5)
    pyautogui.press("tab")
